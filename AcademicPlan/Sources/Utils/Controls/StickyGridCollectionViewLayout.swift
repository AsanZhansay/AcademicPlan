...
class StickyGridCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    func isColumnItemSticky(at indexPath: IndexPath) -> Bool {
        return indexPath.item < stickyColumnsCount
    }
    
    func isRowItemSticky(at indexPath: IndexPath) -> Bool {
        return indexPath.section < stickyRowsCount
    }
    
    func isItemCrossStickies(at indexPath: IndexPath) -> Bool {
        return indexPath.item < stickyRowsCount && indexPath.section < stickyColumnsCount
    }
